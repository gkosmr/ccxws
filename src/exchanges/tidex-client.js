...
class TidexClient extends BasicClient {
  /**
    Documentation:
    https://tidex.gitbook.io/api/websoket-protocol-api/deals-methods/deals-subscribe-method
   */
  constructor({ wssPath = "wss://ws.tidex.com", watcherMs } = {}) {
    super(wssPath, "Tidex", undefined, watcherMs);
